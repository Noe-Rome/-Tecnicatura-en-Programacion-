...
>IMAGEN-1: No cargar imagenes, son archivos de tipo binario<br>
...
Para reescribir la historia del repositorio y eliminar confirmaciones anteriores, se utiliza git reset. Para deshacer cambios de confirmaciones anteriores de formGit reset.<br>
...
Profesor Ariel Betancud<br>
## Clase 8 de Git Bash 
### Introduccion a las ramas o branches de Git parte 9
...
```
Comando en producción: TUVE QUE SOLUCIONAR UN CONFLICTO<br>
```sh
...
Cómo revertir un merge Si nos hemos equivocado y queremos cancelar el merge, debemos usar el siguiente comando:<br>
```sh
git merge --abort
```
...
­- Una vez realizado los cambios en la rama, estas deben fusionarse con 
> git merge.
...
# Lectura 1-B de Git Bash
Configura tus llaves SSH en local<br>
...
pasar prompt a la IA
Pasamos a ver -> Cómo generar tus llaves SSH:<br>
```sh
...
Esto quiere decir que también se utiliza la app de GitHub donde al iniciar sesión desde cualquier dispositivo nos muestra un número que debemos ingresar en la app de nuestro dispositivo celular.<br>
